...
float4 _main(PS_Input Input, constant _Global& _18, texture2d<float> g_texture, sampler g_sampler)
{
    ...
    color += (g_texture.sample(g_sampler, (Input.UV + float2(0.0, (-5.152032375335693359375) / size.y))) * 0.0052916849963366985321044921875);
    color += (g_texture.sample(g_sampler, (Input.UV + float2(0.0, (-3.2509129047393798828125) / size.y))) * 0.07297551631927490234375);
    color += (g_texture.sample(g_sampler, (Input.UV + float2(0.0, (-1.38491213321685791015625) / size.y))) * 0.310199081897735595703125);
    color += (g_texture.sample(g_sampler, (Input.UV + float2(0.0, 1.38491213321685791015625 / size.y))) * 0.310199081897735595703125);
    color += (g_texture.sample(g_sampler, (Input.UV + float2(0.0, 3.2509129047393798828125 / size.y))) * 0.07297551631927490234375);
    color += (g_texture.sample(g_sampler, (Input.UV + float2(0.0, 5.152032375335693359375 / size.y))) * 0.0052916849963366985321044921875);
