...
ImguiPlatformDX12::ImguiPlatformDX12(LLGI::Graphics* g)
 : g_(static_cast<LLGI::GraphicsDX12*>(g))
{
}
...
void ImguiPlatformDX12::Shutdown()
{
...
ImTextureID ImguiPlatformDX12::ToTextureID(LLGI::Texture* texture)
{
