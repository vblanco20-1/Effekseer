...
gl_4_root_path = 'EffekseerRendererGL/EffekseerRenderer/Shader_4/'
...
def transpile_dx9(shaderType, shaderModel, sources, dst_path):
    for f in sources:
...
transpile_gl("vert", "gl4", verts)
transpile_gl("frag", "gl4", frags)
...
transpile_gl("comp", "gl4", gpu_particles_comps)
transpile_gl("vert", "gl4", gpu_particles_verts)
transpile_gl("frag", "gl4", gpu_particles_frags)
